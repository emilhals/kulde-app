...
const links = [
  ...
  { name: 'API Reference', href: '#', description: 'A complete API reference for our libraries.' },
  {
    name: 'Guides',
    href: '#',
    description: 'Installation guides that cover popular setups.',
  },
  { name: 'Blog', href: '#', description: 'Read our latest news and articles.' },
]
const social = [
  {
    name: 'X',
            ...
            {links.map((link, linkIdx) => (
              <li key={linkIdx} className="relative flex gap-x-6 py-6">
                <div className="flex size-10 flex-none items-center justify-center rounded-lg shadow-sm ring-1 ring-gray-900/10">
                  <link aria-hidden="true" className="size-6 text-indigo-600" />
                </div>
