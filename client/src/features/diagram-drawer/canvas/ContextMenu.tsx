...
import { state } from '@/features/diagram-drawer/store'
  ...
  return (
    <div
      ...
      style={{
        ...
        left: position.x,
        zIndex: 10,
        backgroundColor: snap.isDarkMode
          ? snap.darkBackgroundColor
          : snap.lightBackgroundColor,
    ...
    >
      <div className="flex py-3">
        ...
        <div className="flex flex-col justify-center items-center">
          <h3
            style={{
              color: snap.isDarkMode
                ? snap.lightAccentColor
                : snap.darkAccentColor,
            }}
            className="uppercase text-md tracking-wide"
          >
            Info
          </h3>
      ...
      <div className="flex flex-row gap-3 px-4 py-3">
        <button
          ...
          className="border-2 py-2 px-2 text-sm hover:bg-gray-50 border-1 border-gray-100 rounded-sm dark:bg-gray-900 dark:hover:bg-gray-800"
        >
          Duplicate
        </button>
        <button
          onClick={() => useDeleteFromStore(item.id)}
          className="bg-rose-500 px-2 text-white hover:bg-rose-600 text-sm rounded-sm inset-shadow-sm inset-shadow-white/50"
        >
          Remove
        </button>
      </div>
